...
/**
 * Created by Kristen on 3/28/2017.
 */

public class RssItemListFragment extends Fragment implements ItemAdapter.DataSource,
        ItemAdapter.Delegate {

    private static final String BUNDLE_EXTRA_RSS_FEED =
            RssItemListFragment.class.getCanonicalName().concat(".EXTRA_RSS_FEED");
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        BloclyApplication.getSharedDataSource().fetchFeedWithId(feedRowId,
